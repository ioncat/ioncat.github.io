...
**Career Agent** — AI-пайплайн на базе Claude API (Anthropic), созданный для самой сложной части поиска работы: оценить соответствие до того, как вкладываешь усилия в отклик. Отвечает на два вопроса по порядку.
